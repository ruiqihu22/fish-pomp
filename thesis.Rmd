...
wham_data_cached <- bake(file = "wham_data.rds", {
  ...
  # Also fit and save the full WHAM model for other scripts
  if (!file.exists("data/vign_10_mod_1.RData")) {
    cat("Fitting WHAM model (this may take a minute)...\n")
    mod_1 <- fit_wham(input, do.osa = FALSE, do.retro = FALSE)
    save(mod_1, file = "data/vign_10_mod_1.RData")
    cat("Saved WHAM model to data/vign_10_mod_1.RData\n")
  }
